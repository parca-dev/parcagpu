...
// PACKED_ALIGNMENT in CUPTI is: __attribute__((__packed__)) __attribute__((aligned(8)))
...
_Static_assert(sizeof(struct cupti_activity_kernel5) == 160,
               "cupti_activity_kernel5 size mismatch");

#endif // CUPTI_ACTIVITY_BPF_H
